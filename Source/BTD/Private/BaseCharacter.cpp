...
/*状态机 相关 Start*/
void ABaseCharacter::SwitchTopState_Implementation(ETopState InTopState)
{
	TopStateMachine->Transition(new FTopState(this, this, InTopState));
}

void ABaseCharacter::SwitchCombatState_Implementation(ECombatState InCharacterState)
{
	//SetCharacterState(InCharacterState);
