...
public:
	...
	virtual void SwitchTopState_Implementation(ETopState InTopState) override;

	// 实现 IIHolderFunction 接口：改变角色战斗状态
	virtual void SwitchCombatState_Implementation(ECombatState InCharacterState) override;
